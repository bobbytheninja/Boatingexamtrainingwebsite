...
export type Language = 'English' | 'Bulgarian' | 'Spanish' | 'Greek' | 'Italian';
...
export const translations: Record<Language, Translations> = {
  English: {
    ...
    fortyQuestions: 'Tests with 40 randomized exam questions',
  ...
  Bulgarian: {
    ...
    fortyQuestions: 'Тестове с 40 рандомизирани изпитни въпроса',
  ...
  Spanish: {
    ...
    fortyQuestions: 'Pruebas con 40 preguntas de examen aleatorias',
  ...
  Greek: {
    ...
    fortyQuestions: 'Τεστ με 40 τυχαίες ερωτήσεις εξέτασης',
  ...
  Italian: {
    ...
    // Home Page
    heroTitle: 'Padroneggia la Tua Certificazione Marittima',
    heroSubtitle: 'Formazione Professionale per Esami di Yacht e Barche',
    heroDescription: 'Piattaforma di formazione online completa per esami di certificazione marittima. Esercitati con domande d\'esame reali e supera con fiducia.',
    getStarted: 'Inizia',
    ...
    smallBoatDesc: 'Abilità essenziali per la navigazione di piccole imbarcazioni',
    bigBoat: 'Barca Grande',
    bigBoatDesc: 'Tecniche avanzate per imbarcazioni più grandi',
    yacht: 'Yacht (fino a 50 tonnellate)',
    yachtDesc: 'Certificazione professionale per yacht',
    navigationDevice: 'Dispositivo di Navigazione',
    navigationDeviceDesc: 'Padroneggia la tecnologia di navigazione marittima',
    selectExam: 'Seleziona Esame',
    howItWorks: 'Come Funziona',
    howItWorksSubtitle: 'Il tuo percorso verso il successo della certificazione',
    chooseCategory: 'Scegli Categoria',
    chooseCategoryDesc: 'Seleziona tra 5 categorie di esame',
    selectMode: 'Seleziona Modalità',
    selectModeDesc: 'Modalità studio o esame',
    takeExam: 'Sostieni l\'Esame',
    takeExamDesc: '40 domande, 60 minuti',
    getResults: 'Ottieni Risultati',
    getResultsDesc: 'Feedback e analisi istantanei',
    disclaimer: 'Avviso di Formazione',
    disclaimerText: 'Questi esami sono solo a scopo formativo e non forniscono certificazione. Sono progettati per aiutarti a prepararti per gli esami marittimi.',

    // Pricing Page
    pricingTitle: 'Prezzi Semplici e Trasparenti',
    pricingSubtitle: 'Scegli il piano che funziona per te',
    free: 'Gratuito',
    practiceMode: 'Modalità Pratica',
    practiceModeDesc: 'Perfetto per iniziare',
    perMonth: '/mese',
    questionsPerExam: '10 domande di pratica per esame',
    allCategories: 'Tutte le 5 categorie di esame',
    studyExamModes: 'Modalità studio ed esame',
    ...
    contactSubtitle: 'Hai domande? Ci piacerebbe sentirti. Hai opportunità di business per noi riguardo all\'insegnamento di corsi o vorresti pubblicizzare sulla nostra pagina? Ci piacerebbe sentirti ancora di più!',
    ...
    emailUs: 'Inviaci un\'email a',
    location: 'Posizione',
    phone: 'Telefono',

    // Login Page
    welcomeAboard: 'Benvenuto a Bordo',
    signInToContinue: 'Accedi per continuare la tua formazione marittima',
    ...
    demoMode: '✨ Modalità Demo: Inserisci qualsiasi email per continuare',
    ...
    currentExamAccess: 'Il tuo accesso attuale agli esami e periodi di validità',
    noActiveSubscriptions: 'Nessun Abbonamento Attivo',
    noActiveSubscriptionsDesc: 'Non hai ancora nessun abbonamento attivo agli esami',
    ...
    wantMoreExams: 'Vuoi aggiungere più esami?',
    additionalCategories: 'Ottieni accesso a categorie di esame aggiuntive',
    addMore: 'Aggiungi Altri',
    yourProgress: 'I Tuoi Progressi',
    trackPerformance: 'Monitora le tue prestazioni di formazione',
    activeExams: 'Esami Attivi',
    examsCompleted: 'Esami Completati',
    averageScore: 'Punteggio Medio',
    manageAccount: 'Gestisci i tuoi abbonamenti e le impostazioni dell\'account',

    // Exam Mode Selection
    selectExamMode: 'Seleziona Modalità Esame',
    selectModeTitle: 'Scegli il tuo approccio di apprendimento',
    studyMode: 'Studio',
    studyModeDesc: 'Visualizza le risposte corrette immediatamente dopo ogni domanda',
    examMode: 'Esame',
    examModeDesc: 'Simula condizioni d\'esame reali con risultati alla fine',
    mockExam: 'Esame Simulato',
    mockExamDesc: 'Pratica gratuita con domande limitate',
    paidExam: 'Esame a Pagamento',
    paidExamDesc: 'Esperienza d\'esame completa con tutte le domande',
    questionsAvailable: 'domande disponibili',
    unlockAll: 'Sblocca tutte le 40 domande',
    upgradeRequired: 'Aggiornamento Richiesto',
    instantFeedback: 'Feedback istantaneo sulle risposte',
    learnAsPractice: 'Impara mentre pratichi',
    perfectForBeginners: 'Perfetto per principianti',
    realisticExamSim: 'Simulazione d\'esame realistica',
    sixtyMinTimer: 'Timer di 60 minuti',
    resultsAtCompletion: 'Risultati al completamento',
    selectExamType: 'Seleziona Tipo di Esame',
    freePractice: 'Pratica Gratuita',
    freePracticeDesc: 'Prova 10 domande gratuitamente per iniziare',
    tenQuestions: '10 domande di pratica',
    bothStudyExamModes: 'Entrambe le modalità studio ed esame',
    startFree: 'Inizia Gratis',
    fullAccessTitle: 'Accesso Completo',
    fullAccessDescription: 'Formazione completa con tutte le 40 domande',
    fortyQuestions: 'Test con 40 domande d\'esame randomizzate',
    trackProgress: 'Monitora i tuoi progressi',
    startFull: 'Inizia Completo',
    fullAccessNote: 'Nota: L\'accesso completo richiede €5/mese per categoria. Prova la nostra pratica gratuita per sperimentare la piattaforma prima di aggiornare.',
    ...
    answered: 'Risposto',
    answeredCorrectly: 'Risposto Correttamente',
    answeredIncorrectly: 'Risposto Incorrettamente',
    unanswered: 'Non Risposto',
    current: 'Corrente',
    submitAndNext: 'Invia e Successivo',
    next: 'Successivo',
    previous: 'Precedente',
    finish: 'Termina',
    continue: 'Continua',
    ...
    select: 'Seleziona',
    selectMultipleAnswers: 'Seleziona {count} risposte',
    timeUsed: 'Tempo Utilizzato',
    passingScore: 'Punteggio Minimo',
    reviewAnswers: 'Rivedi Risposte',
    retakeExam: 'Ripeti Esame',
    backToExams: 'Torna agli Esami',
    exitExam: 'Esci dall\'Esame',
    exitExamTitle: 'Uscire dall\'Esame?',
    exitExamMessage: 'Perderai tutti i tuoi progressi se esci dall\'esame. Questa azione non può essere annullata.',
    continueExam: 'Continua Esame',
    exitAndLoseProgress: 'Esci e Perdi Progressi',
    submitExamTitle: 'Consegnare l\'Esame?',
    submitExamMessage: 'Sei sicuro di voler consegnare il tuo esame? Non potrai modificare le tue risposte dopo la consegna.',
    cancelSubmit: 'Annulla',
    confirmSubmit: 'Consegna',
    complete: 'Completo',
    ...
    correctAnswerHighlighted: 'La risposta corretta è evidenziata sopra.',
    wantToUpgrade: 'Vuoi esercitarti con tutte le 40 domande?',
    upgradeMessage: 'Aggiorna all\'esame completo per soli €5/mese per categoria.',
    upgradeNowLink: 'Aggiorna Ora →',

    // Payment Page
    selectCategories: 'Seleziona Categorie di Esame',
    selectCategoriesDesc: 'Scegli quali categorie di esame vuoi sbloccare',
    monthlyPerCategory: 'mensile per categoria',
    ...
    securePayment: 'Pagamento sicuro con crittografia standard del settore',
    ...
    partnerBannerText1: '⚓ Maritime Academy Bulgaria - Corsi professionali di vela e certificazioni per yacht',
    partnerBannerText2: '🌊 Black Sea Yacht Charters - Noleggio yacht premium con e senza equipaggio',
    partnerBannerText3: '⛵ Neptune Marine Equipment - Tutta la tua attrezzatura per sicurezza marittima e navigazione',
  },
};
