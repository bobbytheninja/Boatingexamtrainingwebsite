...
export function TermsOfServiceModal({ isOpen, onClose }: TermsOfServiceModalProps) {
  ...
  return (
    <div
      ...
      role="presentation"
    >
      {/* dvh rather than vh: on mobile browsers vh is measured against the full
          viewport including the area behind the URL bar, which pushed the footer
          (and its close button) off-screen. */}
      <div
        className="relative w-full max-w-4xl max-h-[90vh] max-h-[90dvh] flex flex-col overflow-hidden rounded-lg shadow-2xl"
        style={{
      ...
      >
        ...
        {/* Content */}
        <div className="flex-1 min-h-0 overflow-y-auto p-4 sm:p-6 space-y-6 text-[15px] leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-none pl-0 space-y-1 text-gray-800 dark:text-gray-200">
